        ...
        <Reveal>
          <div className="card-border">
            <div className="bg-[hsl(240,10%,3.9%)] p-8 sm:p-12 rounded-lg text-center">
              <div className="w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/[0.06] border border-white/[0.06] flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto mb-4">
                <input
                  ...
                  required
                  className="flex-1 h-12 px-4 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/10 transition-colors"
                />
                <button
                  type="submit"
                  className="h-12 px-6 rounded-lg bg-white text-black font-medium hover:bg-white/90 transition-colors"
                >
                  Subscribe
                </button>
              </form>
