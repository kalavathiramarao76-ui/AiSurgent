            ...
            {cards.map((card) => (
              <RevealItem key={card.title}>
                <div className="card-border group">
                  <div className="relative bg-[hsl(240,10%,3.9%)] p-6 rounded-lg h-full flex flex-col border border-white/[0.06] bg-white/[0.02]">
                    {card.badge && (
                    ...
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 bg-${card.color}/10`}>
                      <card.icon size={24} className={`text-${card.color} group-hover:scale-105 transition-transform duration-200`} />
                    </div>
