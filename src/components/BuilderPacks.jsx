            ...
            <div className="bg-[hsl(240,10%,3.9%)] p-8 sm:p-12 rounded-lg">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <a
                    href="#contact"
                    className="group inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium bg-white text-black hover:bg-white/90 transition-colors"
                  >
                ...
                <div className="relative">
                  <div className="relative border border-white/[0.06] bg-white/[0.02] rounded-2xl p-8">
